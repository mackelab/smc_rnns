...
RUN_SCRIPT = str(Path(__file__).absolute().parent / "train_single_nlb.py")
...
SEARCH_SPACE = {
    ...
    "training_params.k": lambda: rng.choice([64, 128]),  # number of particles
    "vae_params.dim_z": lambda: rng.choice(
        [16, 20, 24, 28, 32, 36]
...
for i in range(n_runs):
    ...
    run_overrides["training_params.lr_end"] = run_overrides["training_params.lr"] * 1e-2
